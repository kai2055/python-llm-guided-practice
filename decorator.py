...
class MLConfig:
    ...
    def __init__(self, learning_rate):
        ...
        def learning_rate(self):
            ...
            # - Calulate the value on the fly
            # - Return a transformaed version of the data
        ...
        def learning_rate(self, value):
            ...
            # IMPORTANT: Store in self._learning_rate NOTself.learning_rate
            # Because self.learning_rate = balue would call this setter again!
...
print("\n Reading VALUE: result = config.learning_rate")
...
print("\n WRITING VALUE: config.learning_rate = 0.75")
print(" This trigger the SETTER")
...
print("\nProblem 2: Witout getters, NO CONTROL over what's returned: ")
